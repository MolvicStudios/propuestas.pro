...
export const translations = {
  es: {
    ...
    step1: {
      ...
      logoHint: 'PNG, JPG o SVG · máx. 2 MB · aparecerá en los exportados',
      logoBtn: 'Subir logo',
    ...
    result: {
      ...
      downloadDocxBtn: '↓ Exportar DOCX',
      downloadPdfBtn: '↓ Exportar PDF',
  ...
  en: {
    ...
    step1: {
      ...
      logoHint: 'PNG, JPG or SVG · max 2 MB · will appear in exports',
      logoBtn: 'Upload logo',
    ...
    result: {
      ...
      downloadDocxBtn: '↓ Export DOCX',
      downloadPdfBtn: '↓ Export PDF',
